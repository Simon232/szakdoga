...
passport.use('registration', new LocalStrategy({
    ...
    function (req, username, password, done) {
        req.app.models.user.findOne({username: username}, function (err, user) {
            ...
            if (user) {
<<<<<<< HEAD
                return done(null, false, {message: 'L√©tez≈ë username.'});
=======
                return done(null, false, {message: 'LÈtezı username.'});
...
<<<<<<< HEAD
//Session eset√©n (opcion√°lis)
=======
//Session esetÈn (opcion·lis)
>>>>>>> 97b55fb17cdcdbe5b4b0f06484de8be33036616d
...
app.post('/registration', passport.authenticate('registration', {
    ...
    failureFlash:       true,
<<<<<<< HEAD
    badRequestMessage:  'Hi√°nyz√≥ adatok'
=======
    badRequestMessage:  'Hi·nyzÛ adatok'
>>>>>>> 97b55fb17cdcdbe5b4b0f06484de8be33036616d
